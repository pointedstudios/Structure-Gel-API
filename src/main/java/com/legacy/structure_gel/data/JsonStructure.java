...
public class JsonStructure extends GelStructure<NoFeatureConfig>
{
	...
	{
		public JsonStart(Structure<?> structureIn, int chunkX, int chunkZ, Biome biomeIn, MutableBoundingBox boundsIn, int referenceIn, long seed)
		{
	...
	public static class JsonPieces
	{
		...
		{
			JigsawManager.func_214889_a(start, size, JsonPieces.Piece::new, chunkGen, template, pos, pieces, seed);
		}
